...
　　<p>在这本书里，我想写现代中国某一部分社会、某一类人物。</p>写这类人，我没忘记他们是人类，只是人类，具有无毛两足动物的基本根性。角色当然是虚构的，但是有考据癖的人也当然不肯错过索隐的杨会、放弃附会的权利的。 
...
export default {
  ...
  methods: {
    last(){
      wx.navigateTo({
        url: '/pages/book2/mulu/qianyan/main'
      })
    },
    list(){
      wx.navigateTo({
